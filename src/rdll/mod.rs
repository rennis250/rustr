...
#[cfg(all(any(target_os="freebsd",target_os="openbsd",target_os="linux",target_os="macos"), target_pointer_width = "64"))]
pub mod unix64;
#[cfg(all(any(target_os="freebsd",target_os="openbsd",target_os="linux",target_os="macos"), target_pointer_width = "64"))]
pub use self::unix64::*;

#[cfg(all(any(target_os="freebsd",target_os="openbsd",target_os="linux"), target_pointer_width = "32"))]
pub mod unix32;
#[cfg(all(any(target_os="freebsd",target_os="openbsd",target_os="linux"), target_pointer_width = "32"))]
pub use self::unix32::*;
